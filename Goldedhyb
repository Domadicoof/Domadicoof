...
ImageButton.Image = "https://www.roblox.com/library/11441217847/RobloxScreenShot20221101-201613021"
...
local Library = Update:Window("GOLDEN V3","",Enum.KeyCode.RightControl);
Main = Library:Tab("MAIN")
M = Library:Tab("MISC FARM")
Ss = Library:Tab("STADS")
