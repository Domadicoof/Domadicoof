...
ThunderToggleUI.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
ThunderToggleUI.BackgroundTransparency = 1.000 
ThunderToggleUI.BorderSizePixel = 0
ThunderToggleUI.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
ThunderToggleUI.Size = UDim2.new(0, 150, 0, 150)
ThunderToggleUI.Font = Enum.Font.SourceSans
ThunderToggleUI.Text = "x"
ThunderToggleUI.TextColor3 = Color3.fromRGB(0, 0, 0)
ThunderToggleUI.TextSize = 0.000
...
ThunderToggleUI.MouseButton1Click:Connect(function()
    ...
    game:GetService("VirtualInputManager"):SendKeyEvent(false,305,false,game)
        ...
        ThunderImageUI.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        ThunderImageUI.BackgroundTransparency = 1.000
        ThunderImageUI.BorderSizePixel = 0
        ThunderImageUI.Position = UDim2.new(0.0, 0, 0.0, 0)
        ThunderImageUI.Size = UDim2.new(0, 150, 0, 150)
        ThunderImageUI.Image = "rbxassetid://13802319074"
...
Page.Position = UDim2.new(0.255426834, 0, 0.195000003, 0)
Page.Size = UDim2.new(0, 400, 0, 305)
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(13769588902) 

	local Top = Instance.new("Frame")
	Top.Name = "Top"
	Top.Parent = Main
	Top.BackgroundColor3 = Color3.fromRGB(255,255,255)
	Top.BackgroundTransparency = 1.10
	Top.Size = UDim2.new(0, 529, 0, 33)
...
local ver1 = Instance.new("Frame")
ver1.Name = "ver"
ver1.Parent = Top
ver1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ver1.BackgroundTransparency = 1.000
ver1.Position = UDim2.new(0.180, 0, 0, 0)
ver1.Size = UDim2.new(0, 60, 0, 67)

local ImageLabel = Instance.new("ImageLabel")
ImageLabel.Name = "ImageLabel"
ImageLabel.Parent = ver1
ImageLabel.BackgroundTransparency = 1.000
ImageLabel.Position = UDim2.new(0, -20, -0.2, 0)
ImageLabel.Size = UDim2.new(1.5, 0, 1.5, 0)
ImageLabel.Image = "http://www.roblox.com/asset/?id="..tostring(13802319074)


local TextLabel = Instance.new("TextLabel")
TextLabel.Name = "TextLabel"
TextLabel.Parent = ver1
TextLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.BackgroundTransparency = 1.000
TextLabel.Position = UDim2.new(0, 70, 0, 0)
TextLabel.Size = UDim2.new(1, -70, 1, 0)
TextLabel.Font = Enum.Font.GothamSemibold
TextLabel.Text = "GOMU HUB"
...
Page.Position = UDim2.new(0.255426834, 0, 0.195000003, 0)
Page.Size = UDim2.new(0, 400, 0, 305)
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(13802350343) 
 ...
 MainPage.Size = UDim2.new(0, 400, 0, 305)
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://13802319074"
...
--------------------------
local Main = Library:Tab("Farm","11446825283")
local Setting = Library:Tab("Setting","11446835336")
local Weapon = Library:Tab("Item","11446859498")
local Race = Library:Tab("Race V4","11446900930")
local Stats = Library:Tab("Stats","11447069304")
local P = Library:Tab("Player","11446900930")
local Teleport = Library:Tab("Teleport","11446920523")
local Dungeon = Library:Tab("Raid","11446957539")
local DevilFruit = Library:Tab("Fruit+Esp","11446965348")
local Shop = Library:Tab("Shop","6031265976")
local Misc = Library:Tab("Misc","11447063791")

--------------------------------------------------------------------

Setting:Label("Subscribe to My Channel For New Updates!")

Setting:Line()

Setting:Button("Copy Channel Link",function()
 
 setclipboard("https://www.youtube.com/channel/UCMhX99w3W24yP7VaDJMlbNQ")
 end)

Setting:Seperator(" Setting ")
Setting:Toggle("Auto Set Spawn Point",true,function(value)
...
_G.DistanceMob = 20
Setting:Slider("Distance Farm",1,100,20,function(value)
 _G.DistanceMob = value
 end)
else
 _G.DistanceMob = 20
Setting:Slider1("Distance Farm",1,100,20,function(value)
 _G.DistanceMob = value
 end)
end
...
Setting:Toggle("Auto Ken Haki ",true,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
Setting:Toggle("Remove Damage",_G.DisableDamage,function(value)
...
Setting:Toggle("White Screen",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
    ...
    Setting:Button("BOOT FPS",function()
        pcall(function()
...
_G.Kill_At = 25
Setting:Slider1("Kill At",1,100,25,function(value)
 _G.Kill_At = value
end)
end
...
Time:Set("[Game Time] : Horas : "..Hour.." Minutos : "..Minute.." Segundos : "..Second)
end
...
Main:Toggle("Auto Farm Select",_G.Auto_Farm_Level,function(value)
 _G.Auto_Farm_Level = value
 StopTween(_G.Auto_Farm_Level)
end)

Main:Toggle("Auto Use Awakening",_G.AutoAwakeningRace,function(value)
...
Main:Dropdown(" Select Monter", tableMon, function(vu)
 SelectMonster = vu
 end)

Main:Toggle("Auto Farm Select Monster",_G.AutoFarmSelectMonster,function(vu)
...
Main:Toggle("Auto Farm Mastery DF",_G.AutoFarmFruitMastery,function(value)
...
Main:Toggle("Anto Farm Boss",_G.Auto_Farm_Boss,function(value)
...
Main:Seperator(" Materials ")
 ...
 local SelectMaterial = Main:Dropdown("Select Materials",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Main:Toggle("Auto Farm Materials",_G.AutoFarmMaterial,function(t)
...
Main:Toggle("Mirage Island HOP",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" Chest ")

Main:Toggle("Auto Farm Chest (Fast)",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle("Auto Farm Chest",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("Instant Teleport",function()
...
Main:Toggle("Auto Trade ",_G.Auto_Trade_Bone,function(value)
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		...
		ObservationLevel:Set("Nível do Haki da Observação : "..tostring(value))
	end
end)
...
wait(1)
Notification:Notify(
   {Title = "Gomu Hub", Description = "You Have Max Observation"},

   {Image = "", ImageColor = Color3.fromRGB(255, 255, 0), Callback = function(State) print(tostring(State)) end}
)
                    else
                        if World2 then
...
Weapon:Seperator(" Item e missões ")
...
local Elite_Hunter_Status = Weapon:Label("Status")
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					Elite_Hunter_Status:Set("Status : Elite Spawned!")	
				else
					Elite_Hunter_Status:Set("Status : Elite Not Spawned")	
				end
			end)
		end
	end)
	...
	spawn(function()
		while wait() do
			Total_Elite_Hunter:Set("Elite Progress  : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Auto Open Dough Raid",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Seperator("Curse  Dual Katana ")
...
Weapon:Toggle("Auto Tushita",_G.Autotushita,function(value)
...
Weapon:Seperator(" Eletric Claw ")

Weapon:Toggle("Auto Eletric Claw",_G.Auto_Electric_Claw,function(value)
...
Stats:Toggle("Auto Stats Fruit",_G.Auto_Stats_Devil_Fruit,function(value)
...
Stats:Button("Reset Stats",function()
...
P:Slider("Fov Size",1,1000,200,function(value)
...
P:Toggle("Aimbot Skill",_G.Aimbot_Skill_Fov,function(value)
...
Playerslist = {}
    ...
    local SelectedPly = P:Dropdown("Selecionar jogador",Playerslist,function(value)
...
P:Toggle("Teleport Player",_G.Teleport_to_Player,function(value)
...
Dungeon:Dropdown("Select Raid",chip,function(value)
 _G.Select_Dungeon = value
end)

Dungeon:Toggle("Auto Buy Chips",_G.Auto_Buy_Chips_Dungeon,function(value)
...
Dungeon:Toggle("Auto Srart Law Raid",_G.Auto_Start_Law_Dungeon,function(value)
...
spawn(function()
 ...
 DevilFruit:Toggle("Bring Fruit",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
...
spawn(function()
 ...
 DevilFruit:Toggle("Bring All DF",_G.BringFruitBF,function(value)
...
if World2 then
	...
	DevilFruit:Toggle("ESP Fruit",false,function(a)
		DevilFruitESP = a
